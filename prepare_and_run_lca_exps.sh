...
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_lca/train_lca_orig_text.txt exp_lca/$model/train_orig_activations.hdf5
echo "STEP: train, 033"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_lca/train_lca_033_text.txt exp_lca/$model/train_033_activations.hdf5
echo "STEP: train, 067"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_lca/train_lca_067_text.txt exp_lca/$model/train_067_activations.hdf5

echo "STEP: test, orig"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_lca/test_lca_orig_text.txt exp_lca/$model/test_orig_activations.hdf5
echo "STEP: test, 033"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_lca/test_lca_033_text.txt exp_lca/$model/test_033_activations.hdf5
echo "STEP: test, 067"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_lca/test_lca_067_text.txt exp_lca/$model/test_067_activations.hdf5
