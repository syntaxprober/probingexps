...
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_chunk/train_bies_orig_text.txt exp_chunk/$model/train_bies_orig_activations.hdf5
echo "STEP: train, 033"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_chunk/train_bies_033_text.txt exp_chunk/$model/train_bies_033_activations.hdf5
echo "STEP: train, 067"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_chunk/train_bies_067_text.txt exp_chunk/$model/train_bies_067_activations.hdf5

echo "STEP: test, orig"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_chunk/test_bies_orig_text.txt exp_chunk/$model/test_bies_orig_activations.hdf5
echo "STEP: test, 033"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_chunk/test_bies_033_text.txt exp_chunk/$model/test_bies_033_activations.hdf5
echo "STEP: test, 067"
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model exp_chunk/test_bies_067_text.txt exp_chunk/$model/test_bies_067_activations.hdf5
