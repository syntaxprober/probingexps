...
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model $datadir/train_text.txt $modeldir/train_activations.hdf5
python3 data_prep/extract_representations-hdf5.py --output-type hdf5 --aggregation average $model $datadir/test_text.txt $modeldir/test_activations.hdf5
